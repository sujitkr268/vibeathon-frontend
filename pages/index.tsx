    ...
    <div className="min-h-screen bg-charcoal text-warmwhite font-inter relative">
      ...
      {bookingToast && (
        <div className="fixed top-24 left-1/2 -translate-x-1/2 z-[200] px-8 py-4 rounded-luxury-lg bg-gradient-to-r from-royalGold via-deepSaffron to-royalGold text-charcoal font-semibold shadow-luxury-lg border-2 border-royalGold animate-[slideIn_0.3s_ease]">
          <div className="flex items-center gap-3">
            ...
            <span className="font-playfair text-lg">Table Booked Successfully!</span>
            <span className="text-2xl">✓</span>
          </div>
        </div>
      )}
      ...
      <div className="relative w-full h-32 md:h-40 overflow-hidden bg-gradient-to-b from-darkWalnut via-charcoal to-charcoal">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          <p className="text-royalGold text-sm tracking-[0.4em] uppercase mb-1">Welcome to</p>
          <h1 className="font-playfair text-2xl md:text-3xl text-warmwhite drop-shadow-lg" style={{ textShadow: '0 2px 12px rgba(212,175,55,0.4)' }}>
            Vibeathon Restro
          </h1>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-royalGold to-terracotta flex items-center justify-center">
              <span className="font-playfair text-charcoal font-bold text-lg">V</span>
            </div>
            <span className="font-playfair text-xl md:text-2xl text-royalGold hidden sm:block">Vibeathon Restro</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <select
                ...
                style={{ backgroundColor: '#3E2723', color: '#F5F0EB', border: '1px solid #D4AF37' }}
              >
                <option value="customer" style={{ backgroundColor: '#3E2723', color: '#F5F0EB' }}>👤 Customer</option>
                <option value="staff" style={{ backgroundColor: '#3E2723', color: '#F5F0EB' }}>👨‍🍳 Staff</option>
              </select>
              <span className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-royalGold text-xs">▼</span>
            </div>
            {view === 'customer' && (
              <div className="relative">
                <button
                ...
                {notifOpen && (
                  <div className="absolute right-0 mt-2 w-72 border-2 rounded-luxury shadow-luxury-lg overflow-hidden z-50"
                       style={{ backgroundColor: '#3E2723', borderColor: '#E6D5C3' }}
                       onClick={(e) => e.stopPropagation()}>
                    <div className="p-3 bg-smokyGray/60 border-b" style={{ borderBottomColor: 'rgba(230, 213, 195, 0.15)' }}>
                      <p className="font-playfair text-royalGold">Notifications</p>
                    </div>
                    <div className="max-h-64 overflow-y-auto">
                      {notifications.map((n, i) => (
                        <div key={i} className="p-3 border-b text-sm hover:bg-smokyGray/30" style={{ borderBottomColor: 'rgba(230, 213, 195, 0.15)', color: '#F5F0EB' }}>
                          {n}
                        </div>
                      ))}
                    </div>
          ...
          <div className="space-y-12">
            ...
            <section>
              <div className="flex items-end justify-between mb-6 flex-wrap gap-3">
                <div>
                  <h2 className="font-playfair text-3xl md:text-4xl text-royalGold mb-2">The Menu</h2>
                  <p className="text-softBeige/70 text-sm">A curated journey of modern Indian luxury</p>
                </div>
                  ...
                  <div className="relative flex items-center gap-4 flex-wrap">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-warmwhite text-sm">
                        Once you confirm your reservation below, the order buttons will unlock instantly.
                      </p>
                    </div>
                  ...
                  >
                    ...
                    <div className="p-5">
                      <div className="flex items-start justify-between mb-2">
                        <h3 className="font-playfair text-xl text-warmwhite">{item.name}</h3>
                        <span className="font-playfair text-xl text-royalGold">${item.price}</span>
                      </div>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-darkWalnut/80 to-smokyGray/40 rounded-luxury-lg p-6 md:p-8 border border-softBeige/10 shadow-luxury">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="font-playfair text-2xl text-royalGold">Book a Table</h3>
                    <p className="text-softBeige/60 text-xs">Reserve your luxury experience</p>
                  </div>
                </div>
                <form onSubmit={submitReservation} className="space-y-4">
                  <div>
                    <label className="block text-xs uppercase tracking-wider text-warmwhite mb-2 font-semibold">Your Name</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-xs uppercase tracking-wider text-warmwhite mb-2 font-semibold">Time</label>
                    <input
                      type="time"
                  ...
                  <div>
                    <label className="block text-xs uppercase tracking-wider text-warmwhite mb-2 font-semibold">Guests: {reservationForm.guests}</label>
                    <input
                      type="range"
                      min={1}
                      max={12}
              ...
              <div className="bg-gradient-to-br from-smokyGray/40 to-darkWalnut/80 rounded-luxury-lg p-6 md:p-8 border border-softBeige/10 shadow-luxury">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="font-playfair text-2xl text-royalGold">Live Queue</h3>
                    <p className="text-softBeige/60 text-xs">Current waiting status</p>
                  </div>
                </div>
                  ...
                  {queue.map((entry, idx) => (
                    ...
                    >
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${
                        idx === 0 ? 'bg-royalGold text-charcoal' : 'bg-smokyGray text-warmwhite'
                      }`}>
                        {entry.position}
                      </div>
                      <div className="flex-1">
                        <p className="font-medium text-warmwhite">{entry.name}</p>
                        <p className="text-xs text-softBeige/60">{entry.guests} guests</p>
                      </div>
                      {idx === 0 && (
                ...
                <div className="p-4 rounded-luxury bg-charcoal/40 border border-dashed border-softBeige/20 text-center">
                  <p className="text-xs uppercase tracking-wider text-softBeige/60 mb-1">Your Position</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h2 className="font-playfair text-3xl text-royalGold">Kitchen Display</h2>
                  <p className="text-softBeige/60 text-sm">Manage orders in real-time</p>
                </div>
              </div>
                ...
                {orders.map((order) => (
                  <div
                    ...
                    className={`bg-gradient-to-br from-darkWalnut to-smokyGray/70 rounded-luxury-lg p-5 border shadow-luxury transition-all ${
                      order.status === 'pending' ? 'border-antiqueBronze/60' :
                      order.status === 'preparing' ? 'border-deepSaffron/60' : 'border-oliveGreen/60'
                    }`}
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <p className="font-playfair text-2xl text-warmwhite">Table {order.tableNumber}</p>
                        <p className="text-xs text-softBeige/50">#{order.id} · {order.timestamp}</p>
                      </div>
                      <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${statusStyles[order.status]}`}>
                        {order.status}
                      </span>
                    </div>
                      ...
                      {order.items.map((it, i) => (
                        <div key={i} className="flex items-center justify-between text-sm">
                          <span className="text-warmwhite">
                            <span className="text-royalGold font-bold mr-2">×{it.quantity}</span>
                            {it.name}
                          </span>
                          <span className="text-softBeige/60">${it.price * it.quantity}</span>
                        </div>
                      ))}
                    </div>
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-xs uppercase tracking-wider text-softBeige/60">Total</span>
                      <span className="font-playfair text-xl text-royalGold">${order.total}</span>
                    </div>
                    {statusNext[order.status] ? (
                      <button
                        onClick={() => updateOrderStatus(order.id, statusNext[order.status]!)}
            ...
            <aside className="bg-gradient-to-br from-darkWalnut/80 to-smokyGray/50 rounded-luxury-lg p-5 border border-softBeige/10 shadow-luxury h-fit sticky top-28">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  <h3 className="font-playfair text-xl text-royalGold">Live Availability</h3>
                  <p className="text-softBeige/60 text-xs">Toggle menu items instantly</p>
                </div>
              </div>
              <div className="space-y-3">
                {menuItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-warmwhite text-sm font-medium truncate">{item.name}</p>
                      <p className={`text-xs ${item.isAvailable ? 'text-oliveGreen' : 'text-antiqueBronze'}`}>
          ...
          <div>
            {!isLoggedIn ? (
              <div className="max-w-lg mx-auto text-center py-20">
                ...
                <h2 className="font-playfair text-3xl text-royalGold mb-3">Manager Access Required</h2>
                <p className="text-softBeige/70 mb-8">Please login using the button above to access the Manager Dashboard.</p>
                <button
              ...
              <>
                ...
                <div className="mb-8 overflow-x-auto border-b border-softBeige/10">
                  <div className="flex gap-2 min-w-max pb-2">
                    {([
                      ...
                      { key: 'inventory', label: '📦 Inventory', gold: false },
                      { key: 'staff', label: '👥 Staff', gold: false },
                      { key: 'analytics', label: '📊 Analytics', gold: false },
                ...
                {managerTab === 'orders' && (
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                      <h3 className="font-playfair text-2xl text-royalGold mb-5">Live Orders</h3>
                      <div className="space-y-3">
                        {orders.map((o) => (
                          <div key={o.id} className="p-4 rounded-luxury bg-darkWalnut/60 border border-softBeige/10 flex items-center justify-between">
                            <div>
                              <p className="font-medium text-warmwhite">Table {o.tableNumber} · #{o.id}</p>
                              <p className="text-xs text-softBeige/60">
                                {o.items.length} items · {o.timestamp}
                              </p>
                            </div>
                            <div className="text-right">
                              <p className="font-playfair text-lg text-royalGold">${o.total}</p>
                              <span className={`text-xs px-2.5 py-0.5 rounded-full uppercase font-semibold ${statusStyles[o.status]}`}>
                                {o.status}
                              </span>
                            </div>
                          </div>
                    ...
                    <div>
                      <h3 className="font-playfair text-2xl text-royalGold mb-5">Reservations</h3>
                      <div className="space-y-3">
                        {reservations.map((r) => (
                          <div key={r.id} className="p-4 rounded-luxury bg-gradient-to-r from-darkWalnut/60 to-smokyGray/40 border border-softBeige/10 flex items-center justify-between">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                <p className="font-medium text-warmwhite">{r.name}</p>
                                <p className="text-xs text-softBeige/60">{r.guests} guests</p>
                              </div>
                            </div>
                            <div className="text-right">
                              <p className="font-playfair text-lg text-royalGold">{r.time}</p>
                              <p className="text-xs text-oliveGreen">✓ Confirmed</p>
                            </div>
                          </div>
                        ))}
                      </div>
                ...
                {managerTab === 'inventory' && (
                  <div>
                    <h3 className="font-playfair text-2xl text-royalGold mb-5">Inventory Stock</h3>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full">
                          <thead className="bg-smokyGray/70 border-b border-softBeige/15">
                            <tr>
                              <th className="text-left px-6 py-4 text-sm uppercase tracking-wider text-royalGold font-semibold">Ingredient</th>
                              <th className="text-left px-6 py-4 text-sm uppercase tracking-wider text-royalGold font-semibold">Stock</th>
                              <th className="text-left px-6 py-4 text-sm uppercase tracking-wider text-royalGold font-semibold">Threshold</th>
                              <th className="text-left px-6 py-4 text-sm uppercase tracking-wider text-royalGold font-semibold">Status</th>
                            </tr>
                          </thead>
                          <tbody>
                            {inventory.map((inv, i) => {
                              ...
                              return (
                                <tr key={inv.id} className={`border-b border-softBeige/5 ${i % 2 ? 'bg-charcoal/20' : ''}`}>
                                  <td className="px-6 py-4 text-warmwhite font-medium">{inv.name}</td>
                                  <td className="px-6 py-4">
                                    <span className={`font-playfair text-lg ${low ? 'text-terracotta' : 'text-royalGold'}`}>
                                      {inv.stock} {inv.unit}
                                    </span>
                                  </td>
                                  <td className="px-6 py-4 text-softBeige/70 text-sm">{inv.threshold} {inv.unit}</td>
                                  <td className="px-6 py-4">
                                    <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                                      low ? 'bg-terracotta/20 text-terracotta border border-terracotta/40' : 'bg-oliveGreen/20 text-oliveGreen border border-oliveGreen/40'
                                    }`}>
                ...
                {managerTab === 'staff' && (
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                      <h3 className="font-playfair text-2xl text-royalGold mb-5">Staff on Duty</h3>
                      <div className="space-y-3">
                        {staffOnDuty.map((s) => (
                          <div key={s.id} className="p-4 rounded-luxury bg-darkWalnut/60 border border-softBeige/10 flex items-center justify-between">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-softBeige/60">{s.role}</p>
                              </div>
                            </div>
                    ...
                    <div>
                      <h3 className="font-playfair text-2xl text-royalGold mb-5">VIP Customer History</h3>
                      <div className="space-y-3">
                        {customerHistory.map((c) => (
                          <div key={c.id} className="p-4 rounded-luxury bg-gradient-to-r from-darkWalnut/60 to-smokyGray/40 border border-royalGold/15">
                            <div className="flex items-center justify-between mb-2">
                              <p className="font-medium text-warmwhite">{c.name}</p>
                              <span className="font-playfair text-royalGold">${c.totalSpent}</span>
                            </div>
                ...
                {managerTab === 'analytics' && (
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="bg-darkWalnut/60 rounded-luxury-lg p-6 border border-softBeige/10 shadow-luxury">
                      <h3 className="font-playfair text-xl text-royalGold mb-6">Daily Sales ($)</h3>
                      <div className="h-72">
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart data={dailySalesData}>
                            <CartesianGrid strokeDasharray="3 3" stroke="#4A4A4A" />
                            <XAxis dataKey="day" stroke="#E6D5C3" fontSize={12} />
                            ...
                            <Bar dataKey="sales" radius={[8, 8, 0, 0]}>
                              {dailySalesData.map((_, idx) => (
                                <Cell key={idx} fill={idx % 2 === 0 ? '#D4AF37' : '#C97D5B'} />
                              ))}
                            </Bar>
                          </BarChart>
                        </ResponsiveContainer>
                    ...
                    <div className="bg-darkWalnut/60 rounded-luxury-lg p-6 border border-softBeige/10 shadow-luxury">
                      <h3 className="font-playfair text-xl text-royalGold mb-6">Popular Categories</h3>
                      <div className="h-72">
                        <ResponsiveContainer width="100%" height="100%">
                          <PieChart>
                            <Pie
                            ...
                            />
                            <Legend
                              wrapperStyle={{ color: '#F5F0EB', fontSize: '12px' }}
                            />
                          </PieChart>
                        </ResponsiveContainer>
                      </div>
                        ...
                        <div className="flex items-center gap-3 mb-6">
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              <h3 className="font-playfair text-2xl text-royalGold">AI Insights · Platinum Tier</h3>
                              <span className="px-2.5 py-0.5 rounded-full bg-deepSaffron text-charcoal text-xs font-bold uppercase tracking-wider">
                                Pro
                              </span>
                            </div>
                            <p className="text-softBeige/70 text-sm">Powered by VibeAI Engine v3.0</p>
                          </div>
                        </div>
                        <div className="space-y-5">
                          <div className="p-5 rounded-luxury bg-charcoal/60 border border-deepSaffron/30 backdrop-blur-sm">
                            <div className="flex items-center gap-2 mb-3">
                              <span className="text-deepSaffron text-lg">📈</span>
                              <h4 className="font-playfair text-lg text-warmwhite">Demand Forecast</h4>
                            </div>
                            <p className="text-softBeige/80 leading-relaxed">
                              <strong className="text-terracotta">Saffron Risotto</strong> stock is depleting fast.
                              Based on weekend trends, <strong className="text-royalGold">86 incidents</strong> will
                              occur by <strong className="text-royalGold">8 PM</strong>.
                              Recommend <span className="bg-oliveGreen/30 px-2 py-0.5 rounded text-oliveGreen border border-oliveGreen/40">increasing prep by 30%</span>.
                            </p>
                          </div>
                          <div className="p-5 rounded-luxury bg-charcoal/60 border border-royalGold/30 backdrop-blur-sm">
                            <div className="flex items-center gap-2 mb-3">
                              ...
                              <h4 className="font-playfair text-lg text-warmwhite">Personalized Recommendation</h4>
                            </div>
                            <p className="text-softBeige/80 leading-relaxed">
                              Customers who order <strong className="text-terracotta">Makhani Lamb</strong> have a{' '}
                              <strong className="text-royalGold text-xl">80%</strong> chance of ordering{' '}
                              <strong className="text-terracotta">Mango Lassi</strong>.
                              Suggest <span className="bg-deepSaffron/30 px-2 py-0.5 rounded text-deepSaffron border border-deepSaffron/40">bundling them</span> to
                              increase average order value by an estimated 18%.
                            </p>
                          </div>
                          <div className="grid grid-cols-3 gap-4 mt-4">
                            <div className="p-4 rounded-luxury bg-gradient-to-br from-royalGold/20 to-transparent border border-royalGold/30 text-center">
                              ...
                              <p className="font-playfair text-2xl text-royalGold">+18%</p>
                              <p className="text-xs text-softBeige/60">Projected Revenue Lift</p>
                            </div>
                            <div className="p-4 rounded-luxury bg-gradient-to-br from-terracotta/20 to-transparent border border-terracotta/30 text-center">
                              <p className="text-3xl mb-1">🎯</p>
                              <p className="font-playfair text-2xl text-terracotta">96%</p>
                              <p className="text-xs text-softBeige/60">Model Confidence</p>
                            </div>
                            <div className="p-4 rounded-luxury bg-gradient-to-br from-oliveGreen/20 to-transparent border border-oliveGreen/30 text-center">
                              <p className="text-3xl mb-1">💎</p>
                              <p className="font-playfair text-2xl text-oliveGreen">Platinum</p>
                              <p className="text-xs text-softBeige/60">Your Tier</p>
                            </div>
                          </div>
                        </div>
                      </div>
        ...
        <div className="fixed inset-0 z-[100] flex">
          ...
          <div className="relative ml-auto w-full max-w-md h-full bg-gradient-to-b from-darkWalnut to-charcoal border-l border-softBeige/15 shadow-2xl flex flex-col animate-[slideIn_0.3s_ease]">
            <div className="p-6 border-b border-softBeige/10 flex items-center justify-between">
              <div>
                <h3 className="font-playfair text-2xl text-royalGold">Your Cart</h3>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              {cart.length === 0 ? (
                <div className="text-center py-16">
                  ...
                  <p className="text-xs text-softBeige/40 mt-1">Add some luxury delights from the menu</p>
                </div>
              ) : (
                cart.map((item) => (
                  <div key={item.menuItemId} className="flex items-center gap-4 p-4 rounded-luxury bg-smokyGray/40 border border-softBeige/10">
                    <div className="flex-1">
                    ...
                    <p className="font-playfair text-lg text-royalGold">${item.price * item.quantity}</p>
                    <button
            ...
            {cart.length > 0 && (
              <div className="p-6 border-t border-softBeige/10 space-y-4 bg-darkWalnut/80">
                <div className="flex items-center justify-between">
                  <span className="text-sm uppercase tracking-wider text-softBeige/70">Subtotal</span>
                  <span className="font-playfair text-2xl text-royalGold">${cartTotal}</span>
                </div>
                <button
                  onClick={placeOrder}
      ...
      <footer className="mt-20 border-t border-softBeige/10 py-10">
        <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
          <p className="font-playfair text-xl text-royalGold mb-2">Vibeathon Restro</p>
          <p className="text-xs text-softBeige/50">Modern Indian Luxury · Crafted for the Hackathon</p>
        </div>
      </footer>
    </div>
  );
